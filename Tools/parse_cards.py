...
class MalifauxCardParser:
    ...
    def __init__(self, verbose: bool = False, overrides_file: str = None):
    ...
    def parse_pdf(self, pdf_path: str) -> Optional[Card]:
        ...
        try:
            ...
            # Construct absolute path to front image
            pdf_dir = Path(pdf_path).parent
            # Go up to find images directory and construct path
            ...
            self.log(f"  Stats: Cost={card.cost}, Df={card.defense}, Sp={card.speed}, Wp={card.willpower}, Sz={card.size}, HP={card.health}")
...
def main():
    ...
    parser_instance = MalifauxCardParser(verbose=args.verbose, overrides_file=args.overrides)
